    ...
    try {
      ...
      if (form.userMode === 'new') {
        const u = await createUser({
          openId: form.newUserOpenId.trim(),
    ...
    <PageShell
      ...
      right={
        <div className="flex items-center gap-1.5">
          <span className="border border-line-soft px-2 py-1 text-[10px] tracking-[0.18em]">PLOT</span>
          <span>·</span>
          <span className="border border-line-soft px-2 py-1 text-[10px] tracking-[0.18em]">USER</span>
          <span>·</span>
          <span className="border border-line-soft px-2 py-1 text-[10px] tracking-[0.18em]">TERM</span>
          <span>·</span>
          <span className="border border-line-soft px-2 py-1 text-[10px] tracking-[0.18em]">CODE</span>
        </div>
      }
    >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  placeholder="微信 openId 或 stub deviceId"
                />
              </div>
              <div className="flex flex-col gap-1.5">
