                ...
                <TableRow key={d.deviceId}>
                  <TableCell className="text-[13px]">
                    <div className="flex flex-col">
                      <span className="text-ink leading-tight">{d.deviceName ?? '—'}</span>
                      {d.deviceNo && (
                        <span className="font-folio text-[10px] text-ink-faint leading-tight">{d.deviceNo}</span>
                      )}
                    </div>
                  </TableCell>
                  <TableCell className="text-[13px]">
                  ...
                  <TableCell className="text-[12px] text-ink-soft">
                    {LOCK_LABEL[d.lockStatus ?? ''] ?? d.lockStatus ?? '—'}
                  </TableCell>
