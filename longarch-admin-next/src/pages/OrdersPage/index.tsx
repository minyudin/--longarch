                  ...
                  <TableRow key={o.orderId}>
                    ...
                    <TableCell className="text-[13px]">
                      {o.plotId ? (
                        <div className="flex flex-col">
                          <span className="text-ink leading-tight">
                            {String(o.plotName ?? o.plotTitle ?? '—')}
                          </span>
                          <span className="font-folio text-[10px] text-ink-faint leading-tight">
                            #{String(o.plotId)}
                            {o.plotNo ? ` · ${String(o.plotNo)}` : ''}
                          </span>
                        </div>
                      ) : (
                        <span className="text-ink-faint">—</span>
                    ...
                    <TableCell className="font-folio">{String(o.payableAmount ?? '—')}</TableCell>
