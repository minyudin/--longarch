...
public class ProductionStartupGuard implements InitializingBean {
    ...
    public ProductionStartupGuard(MqttProperties mqttProperties) {
    ...
    public void afterPropertiesSet() {
        ...
        if (isBlank(wxAppId) || wxAppId.startsWith("wx_stub")) {
            errors.add("wechat.miniapp.app-id must be a real Mini Program app id");
        }
        if (isBlank(wxAppSecret) || wxAppSecret.startsWith("wx_stub")) {
            errors.add("wechat.miniapp.app-secret must be configured");
        }
